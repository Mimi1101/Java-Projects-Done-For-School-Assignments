...
public class WormTester {
    ...
    static ArrayList<String> fromWorm(Worm w) {
      ...
      if(w.getHead() == null) assert w.getTail() == null;
      for(int i=0;true;i++) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        assert eq(worm1.cloneWorm().dissect(),Arrays.asList(arr1)) : "The dissect method did not return a correct result";
        ...
        assert(eq(worm1.cloneWorm().dissect(), toSegmentList(1,4,5,2,3,6,7,8,9))) : "The worm splice method did not work";
